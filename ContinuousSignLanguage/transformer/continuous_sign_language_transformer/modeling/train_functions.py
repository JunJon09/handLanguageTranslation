import transformer.continuous_sign_language_transformer.features as features
...
import transformer.models.cslr_model as cslr_model
import os
import time
...
def forward(model, feature, tokens, feature_pad_mask, tokens_pad_mask,
    ...
    if isinstance(model, cslr_model.TransformerCSLR):
...
def load_model(save_path: str, device: str = "cpu"):
    ...
    model_loaded = cslr_model.TransformerCSLR(
